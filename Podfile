...
def func
  ...
  pod 'HXPhotoPickerObjC' # 相册选择（不使用网络图片功能） https://github.com/SilenceLove/HXPhotoPickerObjC 没有完全兼容横屏
  pod 'HXPhotoPickerObjC/SDWebImage' # 相册选择（使用SDWebImage加载网络图片） https://github.com/SilenceLove/HXPhotoPickerObjC 没有完全兼容横屏
