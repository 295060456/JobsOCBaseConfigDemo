...
JobsDynamicPropSetAndGet(JobsSelectorBlock, selectorBlock, SelectorBlock)
...
JobsDynamicPropSetAndGet(JobsReturnIDBySelectorBlock, retIDBySelectorBlock, RetIDBySelectorBlock)
