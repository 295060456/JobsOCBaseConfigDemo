...
typedef id _Nullable(^JobsReturnIDByCGSizeBlock)(CGSize size);
typedef id _Nullable(^JobsReturnIDByCGRectBlock)(CGRect frame);
typedef id _Nullable(^JobsReturnIDByCGPointBlock)(CGPoint point);
...
typedef NSValue *_Nullable(^JobsReturnValueByCGSizeBlock)(CGSize size);
typedef NSValue *_Nullable(^JobsReturnValueByPointerBlock)(const void *_Nullable data);
typedef NSValue *_Nullable(^JobsReturnValueByPointBlock)(CGPoint point);
typedef NSValue *_Nullable(^JobsReturnValueByVectorBlock)(CGVector data);
typedef NSValue *_Nullable(^JobsReturnValueByRectBlock)(CGRect frame);
typedef NSValue *_Nullable(^JobsReturnValueByAffineTransformBlock)(CGAffineTransform data);
typedef NSValue *_Nullable(^JobsReturnValueByEdgeInsetsBlock)(UIEdgeInsets data);
typedef NSValue *_Nullable(^JobsReturnValueByDirectionalEdgeInsetsBlock)(NSDirectionalEdgeInsets data);
...
typedef __kindof UITextView *_Nullable(^JobsReturnTextViewByTextAlignmentBlock)(NSTextAlignment data);
typedef __kindof UITextView *_Nullable(^JobsReturnTextViewByEdgeInsetsBlock)(UIEdgeInsets insets);
typedef __kindof UITextView *_Nullable(^JobsReturnTextViewByPointBlock)(CGPoint point);
...
typedef __kindof UIButton *_Nullable(^JobsReturnButtonByIDBlock)(id _Nullable data);
...
typedef __kindof UITableViewCell *_Nullable(^JobsReturnTableViewCellByBOOLBlock)(BOOL data);
typedef __kindof UITableViewCell *_Nullable(^JobsReturnTableViewCellByIndexBlock)(NSInteger index);
...
typedef __kindof UITableViewCell *_Nullable(^JobsReturnTableViewCellByImageBlock)(UIImage *_Nonnull image);
typedef __kindof UITableViewCell *_Nullable(^JobsReturnTableViewCellByCorBlock)(UIColor *_Nonnull cor);
...
typedef __kindof UICollectionViewCell *_Nullable(^JobsReturnCollectionViewCellByCorBlock)(UIColor *_Nullable cor);
...
typedef UIImage *_Nonnull(^JobsReturnImageByCGRectBlock)(CGRect frame);
typedef UIImage *_Nonnull(^JobsReturnImageByCGSizeBlock)(CGSize size);
...
typedef CGRect(^JobsReturnCGRectByCGPointBlock)(CGPoint point);
typedef CGRect(^JobsReturnCGRectByCGSizeBlock)(CGSize size);
...
typedef BOOL(^JobsReturnBOOLByViewBlock)(__kindof UIView *_Nullable view);
typedef BOOL(^JobsReturnBOOLByViewControllerBlock)(__kindof UIViewController *_Nullable viewController);
...
typedef __kindof UIButton *_Nullable(^JobsReturnButtonByTitlesBlock)(Jobs_NSStringBlock_3_Arguments);
/// 主/副 富文本内容 title/subTitle
typedef __kindof UIButton *_Nullable(^JobsReturnButtonByAttributedStringsBlock)(Jobs_ReturnButtonByAttributedStringsBlock_Arguments);
/// 主文字内容、字体大小
...
/// NSMutableDictionary
typedef NSMutableDictionary *_Nonnull(^JobsReturnMutableDicByKeyValueBlock)(Jobs_ReturnMutableDicByKeyValueBlock_Arguments);
typedef NSMutableDictionary *_Nonnull(^JobsReturnMutableDicByKey_ValueBlock)(Jobs_ReturnMutableDicByKey_ValueBlock_Arguments);

typedef CGRect(^JobsReturnCGRectByCGFloatAndUIViewBlock)(Jobs_ReturnCGRectByCGFloatAndUIViewBlock_Arguments);
typedef NSIndexPath *_Nonnull(^JobsReturnIndexPathByXYBlock)(Jobs_ReturnIDByCenterBlock_Arguments);
@class UIButtonModel;
typedef __kindof UIButtonModel *_Nullable(^JobsReturnButtonModelByStringAndImagesBlock)(Jobs_ReturnButtonModelByStringAndImagesBlock_Arguments);
