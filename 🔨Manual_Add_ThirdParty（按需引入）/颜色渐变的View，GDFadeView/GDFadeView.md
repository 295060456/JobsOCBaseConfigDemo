...
```objective-c
GDFadeView *iphoneFade = [[GDFadeView alloc] initWithFrame:CGRectMake(0, 0, JobsMainScreen_WIDTH(nil), 40)];
iphoneFade.text = @"伟易博";
...
iphoneFade.center = CGPointMake(JobsMainScreen_WIDTH(nil)/2, 64+100);
